...
class ItineraryController extends Controller
{
    ...
    public function store(Request $request){
      ...
      $Itinerairescreate = Itineraires::create([
        'user_id' => auth()->id(),
        'title'   => $request->title,
        'category'   => $request->category,
        'duration'   => $request->duration,
      ...
      if($Itinerairescreate){
        return response()->json([
          'message' => 'Itineraires created'
        ]);
      }else{
        return response()->json([
          'message' => "not created"
    ...
    {
        $itinerary = Itineraires::where('user_id', Auth::id())->findOrFail($id);
    ...
    {
        $itineraries = Itineraires::with('destinations')->get();
    ...
    {
        $itinerary = Itineraires::findOrFail($id);
